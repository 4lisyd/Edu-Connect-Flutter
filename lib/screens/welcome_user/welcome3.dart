        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Lets Get Started?",style: Theme.of(context).textTheme.headline1,textAlign: TextAlign.center,),
              Lottie.asset("lib/assets/animations/lotties/welcome_email.json",reverse: true,height: 400),
              FlatButton(
